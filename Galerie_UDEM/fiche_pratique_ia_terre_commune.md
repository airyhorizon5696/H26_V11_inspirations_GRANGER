...
![content d'etre la](https://github.com/airyhorizon5696/H26_V11_inspirations_GRANGER/blob/main/Galerie_UDEM/media/content_detre_la.jpg?raw=true)
...
### Mon expérience
- Mon expérience est asser mitiger, je m'attendais a quelque chose de beaucoup plus gros, et probablement plus pousser en terme d'intelligence artificiel, je pensais que j'allais voir des outils / des nouveaux moyen d'utiliser l'ia que je n'avais jamais vu en vrai, ou en ligne sur les réseaux sociaux.
- Sinon ce qui ma plus le plus, c'est l'exposition que j'ai choisis, car je n'avais jamais vraiment entendue parler des ondes alpha et de les utiliser pour changer des images.
